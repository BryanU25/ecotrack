  ...
  return (
    <div className={` ${InputSize[size]} flex flex-col gap-2`}>
      ...
      <div className={`relative`}>
        ...
        } pr-[10px] leading-[21px] text-black placeholder:text-darkGray border-darkGray bg-white border rounded-[15px] focus:border-purple-400  focus:outline-none focus:ring focus:ring-purple-300 focus:ring-opacity-30`}
          disabled={isDisabled}
        />
